...
🎓 ECE @ IIIT Bhopal (2027)

📫 **Email:** prakhar.dwivedi.3782@gmail.com  
📍 **India**
...
I build full-stack applications and AI-powered systems with an emphasis on clarity, scalability, and real-world usefulness.

Currently focused on:
- Backend APIs, system design fundamentals, and database-backed applications  
- Retrieval-Augmented Generation (RAG), OCR pipelines, and applied LLM systems  
- Writing cleaner, maintainable code and understanding engineering trade-offs  

I enjoy competitive programming, but I care more about **shipping things that work**.
